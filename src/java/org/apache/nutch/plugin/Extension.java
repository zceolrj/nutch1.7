...
public class Extension 
{
	...
	public Object getExtensionInstance() throws PluginRuntimeException 
	{
	    ...
	    // of a plugin instance and it extension instance are done by one and only one thread.
	    ...
	    synchronized (getId()) 
	    {
	    	try 
	    	{
		        ...
		        // lazy loading of Plugin in case there is no instance of the plugin already.
