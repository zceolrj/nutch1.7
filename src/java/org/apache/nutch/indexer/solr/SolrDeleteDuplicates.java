 ...
 */
public class SolrDeleteDuplicates implements Reducer<Text, SolrDeleteDuplicates.SolrRecord, Text, SolrDeleteDuplicates.SolrRecord>, Tool 
{
	...
	public static class SolrInputFormat implements InputFormat<Text, SolrRecord> 
	{
		...
		public RecordReader<Text, SolrRecord> getRecordReader(final InputSplit split, final JobConf job,  Reporter reporter)
    				throws IOException 
    	{
			SolrServer solr = SolrUtils.getCommonsHttpSolrServer(job);
	...
	public void reduce(Text key, Iterator<SolrRecord> values, OutputCollector<Text, SolrRecord> output, Reporter reporter)
					throws IOException 
	{
